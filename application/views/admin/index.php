            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <!-- Add university -->
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/uni/all_uni_list') ?>" aria-expanded="false"><i class="fa fa-graduation-cap"></i><span class="hide-menu"> Universities</span></a>
                            <ul aria-expanded="false" class="collapse"> 
                                    <li><a href="<?php echo base_url('admin/uni') ?>"><i class="fa fa-angle-right"></i> Add Universities </a></li>
                                <li><a href="<?php echo base_url('admin/uni/all_uni_list') ?>"><i class="fa fa-angle-right"></i> All Universities</a></li>
                            </ul>
                        </li>
                        <!-- Add college -->
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/college/all_college_list') ?>" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu"> Colleges</span></a>
                            <ul aria-expanded="false" class="collapse"> 
                                    <li><a href="<?php echo base_url('admin/college') ?>"><i class="fa fa-angle-right"></i> Add college </a></li>
                                <li><a href="<?php echo base_url('admin/college/all_college_list') ?>"><i class="fa fa-angle-right"></i> All college</a></li>
                            </ul>
                        </li>
                        <!-- Add course -->
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/course/all_course_list') ?>" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu"> Courses</span></a>
                            <ul aria-expanded="false" class="collapse"> 
                                    <li><a href="<?php echo base_url('admin/course') ?>"><i class="fa fa-angle-right"></i> Add Courses </a></li>
                                <li><a href="<?php echo base_url('admin/course/all_course_list') ?>"><i class="fa fa-angle-right"></i> All Courses</a></li>
                            </ul>
                        </li>
