        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Edit User <a href="<?php echo base_url('admin/college/all_college_list') ?>" class="btn btn-info pull-right"><i class="fa fa-list"></i> All college </a></h4>

                </div>
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('admin/college/update/'.$college->id) ?>" class="form-horizontal" novalidate>
                        <div class="form-body">
                            <br>
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 controls">
                                            <input type="text" name="name" class="form-control" value="<?php echo $college->name; ?>">
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 controls">
                                            <input type="text" name="location" class="form-control" value="<?php echo $college->location; ?>">
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
