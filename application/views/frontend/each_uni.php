...
<?php include "inc/head.php" ?>
 ...
 <div class="py-5 my-5">
   <div class="container">
     <div class="row">
       <div class="col-sm-12">
         <h1 class="display-5 pb-4">University of Ghana</h1>
       ...
       <div class="col-sm-12">
        ...
        <tbody>
            <tr>
                ...
                <td>Credit passes in English, Core Mathematics, Integrated Science, Social Studies, Chemistry, Physics, Biology and Elective Mathematics</td>
            ...
            <tr>
                ...
                <td> Credit passes in English, Core Mathematics, Integrated Science, Social Studies, Chemistry, Biology and either Physics or Elective Mathematics</td>
